<?php 
$whot_info=array(
'Main'=>'Main overview of your character. Preference link is also locate here.
<br>Like Changing Account Password, Email and Site color or Submitting you photo to the main LoL site.
<br>Also located here are the Friends link and Control Panel for the Game Admin.',
'Paper'=>'This is a in game news paper',
'Duels'=>'Results of recently fought duels.',
'Graves'=>'Rest in peace',
'Steals'=>'Best thievery operations.',
'Matches'=>'Tournament outcomes.',
...
<br><br>
And the only place to find powerfull stats charms that gives you a bonus boost for a period of time on one or multiple stats!',
'Challenge'=>'Challenge other online players.',
...
'Tourney'=>'The LoL tournaments, to join a tournament you must give a percentage of your experience and gold to fight in the tournament. The amount depends on your Level. If you are low on experience or gold you will be not allowed to join the tournament. You can gain max 50% of the total experience and gold.',
